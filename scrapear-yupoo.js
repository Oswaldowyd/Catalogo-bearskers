/**
 * scrapear-yupoo.js — Scraper interactivo para CUALQUIER tienda Yupoo
 * ===================================================================
 * Sin dependencias (Node 18+). Pega un link de Yupoo, elige qué
 * categorías quieres (solo shorts, t-shirts, etc.) y el script:
 ...
 *   5. Limpia los nombres y MERGEA todo en tu productos.js e
 *      imgs-locales.js existentes (NO borra lo de bearskers).
 *
 * USO (CMD o PowerShell, dentro de esta carpeta):
...
function cleanProductName(raw, catFallback, id) {
  ...
  s = s.replace(/\s+/g, ' ').trim();
  // Title-case solo palabras totalmente en mayúsculas comunes de tipo de prenda
...
async function main() {
  ...
  log('   Abre index.html — las categorías nuevas aparecen en el menú lateral bajo el grupo "' + grupo + '".');
}
